...
export function Hero() {
  return (
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-green-900 sm:text-7xl dark:text-white">
        Somos{' '}
        <span className="relative whitespace-nowrap text-green-600 dark:text-green-400">
          <svg
            aria-hidden="true"
            viewBox="0 0 418 42"
            className="absolute left-0 top-2/3 h-[0.58em] w-full fill-green-300/70 dark:fill-green-600/70"
      ...
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-green-700 dark:text-gray-300">
      ...
      <div className="mt-10 flex justify-center gap-x-6">
        ...
        >
          <svg
            aria-hidden="true"
            className="h-3 w-3 flex-none fill-green-600 group-active:fill-current dark:fill-gray-300"
          >
            <path d="m9.997 6.91-7.583 3.447A1 1 0 0 1 1 9.447V2.553a1 1 0 0 1 1.414-.91L9.997 5.09c.782.355.782 1.465 0 1.82Z" />
          </svg>
          <span className="ml-3 dark:text-white">Video</span>
        </Button>
      </div>
      <div className="mt-36 lg:mt-44">
        <p className="font-display text-base text-green-900 dark:text-white">
